...
export default function RadarChart(g: d3.Selection<SVGGElement, unknown, null, undefined>, props: ChartPluginProps) {
  const { data, yAxis, width, height, colorScale } = props;
