      ...
      {activeSection === 'users' && (
                ...
                <DataTable 
                  ...
                  columns={[
                    ...
                    },
                    {
                      key: 'role',
                      label: 'Rôle',
                      render: (val) => <Badge variant={val === 'Admin' ? 'info' : 'neutral'} className="text-[10px]">{val}</Badge>
                    },
                    {
                      key: 'status',
                      label: 'Statut',
                      render: (val) => (
                        <div className="flex items-center gap-2">
                          <div className={cn("w-1.5 h-1.5 rounded-full", val === 'Active' ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-border")}></div>
                          <span className="text-[10px] font-bold text-foreground opacity-80 uppercase tracking-widest">{val}</span>
                        </div>
                      )
                    },
                    {
                      ...
                      render: (val) => <span className="text-[10px] text-muted-foreground font-medium">{val}</span>
                    },
                    {
                      key: 'actions',
                      label: 'Actions',
              ...
              <DataTable 
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    label: 'Force Size',
                    render: (val) => (
                      <Badge variant="neutral" className="bg-muted text-foreground border-border px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest">{val} Members</Badge>
                    )
                  },
                  {
                    key: 'created',
        ...
        {activeSection === 'sources' && (
          ...
          >
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <h2 className="text-4xl font-semibold text-foreground tracking-tight">Data Sources</h2>
                <p className="text-muted-foreground text-lg font-light">Infrastructure de données et connecteurs externes.</p>
              </div>
              <button 
                onClick={() => {
                  setSelectedDatabase(null);
                ...
                {isLoading ? (
                  ...
                  <div className="col-span-full py-24 text-center glass-panel border-dashed p-12">
                     <div className="max-w-md mx-auto space-y-6">
                        ...
                        <p className="text-muted-foreground font-light">Le cerveau de Hifadih BI a besoin de données pour fonctionner. Connectez votre première base de données pour commencer le voyage.</p>
                        <button 
                    ...
                    <div className="lg:col-span-4 space-y-12">
                        ...
                        <div className="p-6 bg-accent/5 rounded-3xl border border-accent/10 space-y-4">
                            ...
                            <p className="text-[10px] text-muted-foreground font-medium leading-relaxed italic">
                                "Hifadih BI utilise un cryptage AES-256 pour stocker vos credentials de base de données. Aucune donnée n'est stockée sur nos serveurs de manière déchiffrée."
                            </p>
                        </div>
                    </div>
                                        ...
                                        <div className="p-6 rounded-3xl border border-border bg-muted/20 flex items-center justify-between group hover:border-accent/30 transition-all">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-muted-foreground">Chiffre toutes les données en transit entre Hifadih BI et votre DB.</p>
                                                </div>
                                            </div>
                                            <button 
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-3">
                    ...
                    <input type="text" defaultValue="Hifadih BI" className="w-full px-5 py-4 bg-muted/30 border border-border focus:bg-background focus:border-accent focus:ring-8 focus:ring-accent/5 rounded-2xl text-sm font-bold transition-all outline-none text-foreground" />
                  </div>
                  <div className="space-y-3">
