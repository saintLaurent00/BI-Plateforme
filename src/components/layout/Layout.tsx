            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              {isSidebarOpen && (
                <div className="flex flex-col">
                  <span className="font-bold tracking-tight text-lg leading-none">Hifadih BI</span>
                  <span className="text-[10px] text-muted-foreground font-serif italic tracking-wide">Data Intelligence</span>
                </div>
              )}
            </Link>
          </div>
