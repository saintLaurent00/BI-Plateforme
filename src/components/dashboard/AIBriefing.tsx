...
export const AIBriefing = ({ dashboardName }: AIBriefingProps) => {
  ...
  React.useEffect(() => {
    ...
    const briefs = [
      ...
      `L'IA Hifadih est à votre service. Le dashboard ${dashboardName} est prêt.`,
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-start gap-8">
        ...
        <div className="space-y-4 max-w-3xl">
          <div className="flex items-center gap-2 text-accent">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em]">Briefing Stratégique Hifadih AI</span>
          </div>
